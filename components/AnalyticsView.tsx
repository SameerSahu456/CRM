    ...
    <div className="p-8 space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-soft border border-slate-200">
          <h3 className="text-xl font-bold text-slate-900 font-display mb-6">Revenue vs Lead Volume</h3>
        ...
        {/* Growth Trend */}
        <div className="bg-white p-8 rounded-2xl shadow-soft border border-slate-200">
          <h3 className="text-xl font-bold text-slate-900 font-display mb-6">Monthly Growth Trend</h3>
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {['Avg Deal Size', 'Sales Cycle Length', 'Win Rate'].map((metric, i) => (
          <div key={i} className="bg-gradient-to-br from-brand-600 to-brand-800 p-6 rounded-2xl shadow-glow text-white relative overflow-hidden group">
            ...
            <p className="text-brand-100 font-medium text-sm font-display uppercase tracking-wide relative z-10">{metric}</p>
            <h4 className="text-3xl font-brand font-bold mt-2 relative z-10">
              {i === 0 ? '$12.4k' : i === 1 ? '18 Days' : '34%'}
            </h4>
            <div className="mt-4 flex items-center text-sm font-medium text-brand-200 relative z-10">
